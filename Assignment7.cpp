...
/*
Problem Statement - Write a Program in C++ to use map associative container. The
                    keys will be the names of states and the values will be the
                    population of the states. When the program runs, the user is
                    prompted to type the name of a state. Then program looks in
                    map, using the state name as an index and returns the population
                    of the state.
*/
